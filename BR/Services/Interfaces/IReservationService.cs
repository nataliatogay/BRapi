...
namespace BR.Services.Interfaces
{
    public interface IReservationService
    {
        ...
        Task<ServerResponse<ICollection<ReservationInfoForClient>>> GetAllReservationsByClient(string clientIdentityId);
        ...
        Task<ServerResponse<ICollection<ReservationInfoForClient>>> GetAllReservationsByOwner(int clientId, string clientIdentityId);
        ...
        Task<ServerResponse> AddConfirmedReservationByClient(ConfirmReservationRequest confirmRequest, string clientIdentityId);

        Task<ServerResponse> AddConfirmedReservationByOwner(ConfirmReservationRequest confirmRequest, string ownerIdentityId);
