...
namespace BR.Migrations
{
    ...
    [Migration("20200512112111_add_cancelled_event")]
    partial class add_cancelled_event
    {
            ...
            modelBuilder.Entity("BR.Models.AdminNotification", b =>
                {
                    ...
                    b.HasIndex("OwnerRequestId")
                        .IsUnique()
                        .HasFilter("[OwnerRequestId] IS NOT NULL");
            ...
            modelBuilder.Entity("BR.Models.AdminNotification", b =>
                {
                    ...
                    b.HasOne("BR.Models.OwnerRequest", "OwnerRequest")
                        .WithOne("AdminNotification")
                        .HasForeignKey("BR.Models.AdminNotification", "OwnerRequestId");
                });
