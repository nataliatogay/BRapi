...
namespace BR.Migrations
{
    ...
    [Migration("20191030144843_edit_admin_model")]
    partial class edit_admin_model
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BR.Models.ApplicationIdentityUser", b =>
                {
            ...
            modelBuilder.Entity("BR.Models.TableReservation", b =>
                {
                    ...
                    b.HasKey("TabletId", "ReservationId");

                    b.HasAlternateKey("ReservationId", "TabletId");
            ...
            modelBuilder.Entity("BR.Models.Admin", b =>
                {
                    b.HasOne("BR.Models.ApplicationIdentityUser", "Identity")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BR.Models.ApplicationIdentityUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
